                        ...
                        <form action="edita_dispensa.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea type="text" class="form-control" name="motivo" required> <?php echo isset($registro['motivo']) ? $registro['motivo'] : ''; ?> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex ">
                                ...
                                <div class=" col-md-3 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="responsavel_cadastro" value="<?php echo isset($registro['nome_funcionario']) ? $registro['nome_funcionario'] : ''; ?>" required>
                                </div>
                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary">Responsável por Autorizar:</label> <br>
                                    <input type="text" class="form-control" name="responsavel_autorizar" value="<?php echo isset($registro['nome_responsavel']) ? $registro['nome_responsavel'] : ''; ?>" required>
                                </div>
                                <div class=" col-md-2 mb-4">
                                    <label class="form-label fw-bold text-secondary">Tipo:</label> <br>
                                    <select class="form-select" name="tipo_resp" value="<?php echo isset($registro['tipo_resp']) ? $registro['tipo_resp'] : ''; ?>" id="">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-5 mb-4">
                                    ...
                                    <input type="date" class="form-control" name="data_cadastro" value="<?php echo isset($registro['data_registro']) ? $registro['data_registro'] : ''; ?>" required>
                                </div>

                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary text-align-center">Horário:</label> <br>
                                    <input type="time" class="form-control" name="horario_dispensa" value="<?php echo isset($registro['horario_registro']) ? $registro['horario_registro'] : ''; ?>" id="">
                                </div>
                            </div>


                            <div class="d-flex mt-4 justify-content-between">
                                <a href="lista_alunos.php" class="btn btn-danger rounded-pill px-4 mb-4">
