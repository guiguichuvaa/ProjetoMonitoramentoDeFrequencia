            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Editar Atestado</h2>
                    </div>
                        ...
                        <form action="edita_atestado.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <?php if (!empty($registro['arquivo'])): ?>
                                        <small class="text-muted">Arquivo atual já cadastrado. Envie um novo arquivo apenas se quiser substituir.</small>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-5 mb-4">
                                    ...
                                    <input type="date" class="form-control" name="data_registro" value="<?php echo isset($registro['data_registro']) ? $registro['data_registro'] : ''; ?>" required>
                                </div>

                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary text-align-center">Dias Cobertos:</label> <br>
                                    <input type="number" class="form-control" name="qtd_dias_cobertos" value="<?php echo isset($registro['dias_cobertos']) ? $registro['dias_cobertos'] : ''; ?>" required max="365" min="1">
                                </div>
                            </div>


                            <div class="d-flex mt-4 justify-content-between">
                                <a href="lista_registros.php?" class="btn btn-danger rounded-pill px-4 mb-4">
