...
$queryRegistro = "SELECT * FROM registro WHERE matricula = ? AND tipo_registro = 'Atraso' ORDER BY data_registro DESC LIMIT 1";
...
<head>
    ...
    <title>Cadastrar Atraso - FrequenCy</title>
...
<body>
            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Visualizar Atraso</h2>
                    </div>
                    <div class="card-body p-4 p-md-5 bg-white w-100">
                        ...
                        <form action="edita_atraso.php" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-8 mb-3">
            <label class="form-label fw-bold text-secondary">Motivo do Atraso</label> <br>
            <label class="form-control" name="motivo" required> <?php echo $registro['motivo']; ?> </label>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mb-3">
            ...
            <span><?php echo $registro['tipo_registro']; ?></span>
        </div>
    </div>
    ...
    <div class="row d-flex">
        ...
        <div class=" col-md-8 mb-4">
            ...
            <label class="form-control" name="responsavel_cadastro" required> <?php echo $registro['nome_funcionario']; ?> </label>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class=" col-md-5 mb-4">
            <label class="form-label fw-bold text-secondary">Data de Cadastro:</label> <br>
            <label class="form-control" name="data_cadastro" required> <?php echo date('d/m/Y', strtotime($registro['data_registro'])); ?> </label>
        </div>

        <div class=" col-md-3 mb-4">
            <label class="form-label fw-bold text-secondary">Horário:</label> <br>
            <label class="form-control" name="horario_atraso" required> <?php echo date('H:i', strtotime($registro['horario_registro'])); ?> </label>
        </div>
    </div>

    <div class="gap-4 mt-4 d-flex justify-content-end">
        <a href="tela_edita_atraso.php?matricula=<?php echo $registro['matricula']; ?>" class="btn btn-signup btn-lg rounded-pill fw-bold text-uppercase">Editar</a>
    </div>
</form>
                    </div>
                </div>
