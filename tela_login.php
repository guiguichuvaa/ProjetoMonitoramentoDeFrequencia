                    ...
                    <div class="card-body p-4 p-md-5 bg-white">
                        ...
                        <form action="login.php" method="POST">
                            ...
                            <div class="d-flex mt-4 justify-content-between">
                                <a href="pg_inicial.php" class="btn btn-danger rounded-pill px-4 mb-4">
                                ...
                                <button type="submit" class="btn btn-signup btn-lg rounded-pill fw-bold text-uppercase">Entrar</button>
                            </div>
                    </div>
                        </form>
                    </div>
