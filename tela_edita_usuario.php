                        ...
                        <form action="edita_usuario.php" method="POST">
                            ...
                            <div class="row g-3 mb-4 justify-content-end">
                                ...
                                <div class=" col-md-6">
                                    ...
                                    <div class="d-flex gap-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_autorized" id="inativo" value="0" <?php echo converte_autorizacao($usuario['is_autorized']) == 'Inativo' ? 'checked' : ''; ?>>
                            ...
                            <div class="d-flex mt-4 justify-content-between">
                                <a href="lista_usuario.php" class="btn btn-danger rounded-pill px-4 mb-4">
