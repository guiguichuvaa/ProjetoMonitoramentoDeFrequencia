<nav class="navbar shadow-sm" style="background-color: #eaf5ee;">
    <div class="container-fluid px-2 px-sm-3 px-md-4 px-lg-5">
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="painel.php">
            <img style="width: clamp(40px, 10vw, 50px); height: auto; aspect-ratio: 1; object-fit: contain;" src="download.png" alt="Logo">
            <div>
                ...
                <ul class="navbar-nav flex-grow-1 fs-5 gap-2 px-4 pt-4 position-relative" style="z-index: 10;">
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="perfil_usuario.php?email_usuario=<?= urlencode($emailUsuario) ?>" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-person" viewBox="0 0 16 16">
                                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="painel.php" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-kanban" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="lista_frequencia.php" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-clipboard-check" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="lista_alunos.php" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="lista_registro.php" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-file-earmark-ruled" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3" href="tela_cadastro_aluno.php" style="color: #1c3249; font-weight: 500;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#0d8a4f" class="bi bi-person-plus" viewBox="0 0 16 16">
