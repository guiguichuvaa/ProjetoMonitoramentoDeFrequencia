            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Editar de Atraso</h2>
                    </div>
                        ...
                        <form action="edita_atraso.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <textarea class="form-control" name="motivo" required> <?php echo $registro['motivo']; ?> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex">
                                ...
                                <div class=" col-md-8 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="responsavel_cadastro" value="<?php echo $registro['nome_funcionario']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-5 mb-4">
                                    ...
                                    <input type="date" class="form-control" name="data_cadastro" value="<?php echo $registro['data_registro']; ?>" required>
                                </div>

                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary">Horário:</label> <br>
                                    <input type="time" class="form-control" name="horario_atraso" value="<?php echo $registro['horario_registro']; ?>" required>
                                </div>
                            </div>
