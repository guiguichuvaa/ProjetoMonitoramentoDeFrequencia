...
if (isset($_GET['matricula'])) {
    ...
    $query = "SELECT id_aluno, nome_aluno, turma_aluno, numero_aluno, matricula FROM aluno WHERE matricula = ?";
            ...
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Editar Aluno</h2>
                    </div>
                    <div class="card-body p-4 p-md-5 bg-white">
                        ...
                        <form action="edita_aluno.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nome" value="<?php echo $aluno['nome_aluno'] ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <select class="form-select" name="turma" aria-label="Default select example">
                                        <option selected>Escolha aqui a turma:</option>
                                        <option value="1A" <?php if ($aluno['turma_aluno'] == '1A') echo 'selected'; ?>>1º Ano A</option>
                                        <option value="1B" <?php if ($aluno['turma_aluno'] == '1B') echo 'selected'; ?>>1º Ano B</option>
                                        <option value="1C" <?php if ($aluno['turma_aluno'] == '1C') echo 'selected'; ?>>1º Ano C</option>
                                        <option value="1D" <?php if ($aluno['turma_aluno'] == '1D') echo 'selected'; ?>>1º Ano D</option>
                                        <option value="2A" <?php if ($aluno['turma_aluno'] == '2A') echo 'selected'; ?>> 2º Ano A</option>
                                        <option value="2B" <?php if ($aluno['turma_aluno'] == '2B') echo 'selected'; ?>> 2º Ano B</option>
                                        <option value="2C" <?php if ($aluno['turma_aluno'] == '2C') echo 'selected'; ?>>2º Ano C</option>
                                        <option value="2D" <?php if ($aluno['turma_aluno'] == '2D') echo 'selected'; ?>>2º Ano D</option>
                                        <option value="3A" <?php if ($aluno['turma_aluno'] == '3A') echo 'selected'; ?>>3º Ano A</option>
                                        <option value="3B" <?php if ($aluno['turma_aluno'] == '3B') echo 'selected'; ?>>3º Ano B</option>
                                        <option value="3C" <?php if ($aluno['turma_aluno'] == '3C') echo 'selected'; ?>>3º Ano C</option>
                                        <option value="3D" <?php if ($aluno['turma_aluno'] == '3D') echo 'selected'; ?>>3º Ano D</option>
                                    </select>
                                </div>

                                <div class="col-md-2 mb-3">
                                    <label class="form-label fw-bold text-secondary">Número:</label>
                                    <input type="number" class="form-control" name="numero" value="<?php echo $aluno['numero_aluno'] ?>" required min="1" max="45">
