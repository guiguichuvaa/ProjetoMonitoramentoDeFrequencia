            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Cadastro de Atestado</h2>
                    </div>
                    <div class="card-body p-4 p-md-5 bg-white w-100">
                        ...
                        <form action="cadastro_atestado.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-5 mb-4">
                                    ...
                                    <input type="date" class="form-control" name="data_registro" value="" required>
                                </div>

                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary text-align-center">Dias Cobertos:</label> <br>
                                    <input type="number" class="form-control" name="qtd_dias_cobertos" value="" required max="365" min="1">
                                </div>
                            </div>
