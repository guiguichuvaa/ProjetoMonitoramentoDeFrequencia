...
$queryRegistro = "SELECT * FROM registro WHERE matricula = ? AND tipo_registro = 'Dispensa' ORDER BY data_registro DESC LIMIT 1";
...
$registro = mysqli_stmt_get_result($stmtRegistro);
if ($registro && mysqli_num_rows($registro) > 0) {
    $registro = mysqli_fetch_assoc($registro);
} else {
    echo "Nenhum registro de atraso encontrado para este aluno.";
    exit;
}
            ...
            <div class="col-12 col-md-12 col-lg-10">
                ...
                <div class="card card-auth shadow-lg">
                    <div class="card-header-orange">
                        <h2 class="fs-4 fw-bold mb-0">Visualizar Dispensa</h2>
                    </div>
                    <div class="card-body p-4 p-md-5 bg-white w-100">
                        ...
                        <form action="edita_dispensa.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <label type="text" class="form-control" name="motivo" required> <?php echo isset($registro['motivo']) ? $registro['motivo'] : ''; ?> </label>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex ">
                                ...
                                <div class=" col-md-3 mb-4">
                                    ...
                                    <label type="text" class="form-control" name="responsavel_cadastro" required> <?php echo isset($registro['nome_funcionario']) ? $registro['nome_funcionario'] : ''; ?> </label>
                                </div>
                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary">Responsável por Autorizar:</label> <br>
                                    <label type="text" class="form-control" name="responsavel_autorizar" required> <?php echo isset($registro['nome_responsavel']) ? $registro['nome_responsavel'] : ''; ?> </label>
                                </div>
                                <div class=" col-md-2 mb-4">
                                    <label class="form-label fw-bold text-secondary">Tipo:</label> <br>
                                    <label type="text" class="form-control" name="tipo_resp" required> <?php echo isset($registro['tipo_responsavel']) ? $registro['tipo_responsavel'] : ''; ?> </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-5 mb-4">
                                    ...
                                    <label type="date" class="form-control" name="data_cadastro" required> <?php echo isset($registro['data_registro']) ? date('d/m/Y', strtotime($registro['data_registro'])) : ''; ?> </label>
                                </div>

                                <div class=" col-md-3 mb-4">
                                    <label class="form-label fw-bold text-secondary text-align-center">Horário:</label> <br>
                                    <label type="time" class="form-control" name="horario_dispensa" required> <?php echo isset($registro['horario_registro']) ? date('H:i', strtotime($registro['horario_registro'])) : ''; ?> </label>
                                </div>
                            </div>


                            <div class="gap-4 mt-4 d-flex justify-content-end">
                                <a href="tela_edita_dispensa.php?matricula=<?php echo $registro['matricula']; ?>" class="btn btn-signup btn-lg rounded-pill fw-bold text-uppercase">Editar</a>
                            </div>
                        </form>
                    </div>
                </div>
